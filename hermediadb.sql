...
INSERT INTO `categoria_producto`(`material`, `dimensiones`, `peso`, `imagen`)
VALUES ("Plastico", "10x5x5 cm", 100.00, "")

INSERT INTO `producto` (`nombre_producto`, `descripcion_producto`, `precio_venta`, `stock`, `dimensiones`,`Categoria_producto_categoria_producto`)
VALUES ("Soporte para Celular", "Base ajustable para sostener el celular en escritorio.", 150, 50, "10x5x5 cm","tecnologia" ), ("Soporte para Celular", "Base ajustable para sostener el celular en escritorio.", 150, 50, "10x5x5 cm", "tecnologia");
